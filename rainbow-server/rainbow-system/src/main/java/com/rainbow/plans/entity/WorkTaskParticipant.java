...
@Entity
@Table(name = "work_task_participant")
@org.hibernate.annotations.Table(appliesTo = "work_task_participant", comment = "任务参与者表")
@SearchFilter(@Keyword(key = "status", value = "0"))
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties({"fcd", "fcu", "lcd", "lcu"})
public class WorkTaskParticipant extends BaseEntity {
  ...
  public WorkTaskParticipant() {

  }

  public WorkTaskParticipant(String planId, String userId, ParticipantRole role) {
    this.planId = planId;
    this.userId = userId;
    this.role = role;
  }
